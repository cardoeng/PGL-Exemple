            ...
            <div class="modal-content">
                    ...
                    <form ref="memberForm" id="memberForm" @submit.prevent="submit">
                        <div class="mb-2">
                            ...
                            <input type="number" id="matricule" class="form-control"
                                :class="(v$.id.$invalid) ? 'is-invalid' : 'is-valid'" placeholder="Matricule"
                                v-model="formState.id" :disabled="block || props.blockId" />
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" id="firstName" class="form-control"
                                :class="(v$.firstName.$invalid) ? 'is-invalid' : 'is-valid'" placeholder="Prénom"
                                v-model="formState.firstName" :disabled="block" />
                        </div>
                        <div class="mb-2">
                            <label for="lastName" class="form-label">Nom*</label>
                            <input type="text" id="lastName" class="form-control"
                                :class="(v$.lastName.$invalid) ? 'is-invalid' : 'is-valid'" placeholder="Nom"
                                v-model="formState.lastName" :disabled="block" />
                        </div>
                        <div class="mb-2">
                            <label for="email" class="form-label">Email*</label>
                            <div class="input-group">
                                <input type="text" id="email" class="form-control"
                                    :class="(v$.email.$invalid) ? 'is-invalid' : 'is-valid'" placeholder="Email"
                                    v-model="formState.email" :disabled="block" />
                        ...
                        <div class="mb-2">
                            ...
                            <select id="status" class="form-control"
                                :class="(v$.status.$invalid) ? 'is-invalid' : 'is-valid'" v-model="formState.status"
                        ...
                        <div class="mb-2">
                            ...
                            <br>
                            <VueDatePicker id="beginDate" ref="beginDatePicker" v-model="formState.beginDate"
                                class="form-control" :class="(v$.beginDate.$invalid) ? 'is-invalid' : 'is-valid'"
                                format="yyyy-MM-dd" :disabled="block" required />
                        </div>
                        <div class="mb-2">
                            <label for="endDate" class="form-label">Date de fin</label>
                            <br>
                            <VueDatePicker id="endDate" v-model="formState.endDate" class="form-control" format="yyyy-MM-dd"
                                :disabled="block" />
                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" @click="submit"
                        :disabled="block || !validForm">Confirmer</button>
